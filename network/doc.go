...
The test network utilizes GaiaApp as the ABCI application and uses all the modules
defined in the gaia. An in-process test network can be configured with any
