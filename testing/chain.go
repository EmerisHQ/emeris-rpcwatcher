...
import (
	...
	"github.com/allinbits/emeris-rpcwatcher/testing/mock"
...
func NewTestChain(t *testing.T, setup DefaultTestingAppInit, chainID string) *TestChain {
	...
	app := SetupWithGenesisValSet(t, setup, valSet, []authtypes.GenesisAccount{acc}, balance)
